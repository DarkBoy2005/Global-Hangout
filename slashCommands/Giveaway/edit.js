	...
	options: [
	  ...
	  {"String":
		...
		{"String":
			{
				name: "newPrize",
				description: "The new price of the giveaway",
				required: true,
			}
		},
		{"Integer":
		...
		{"String":
			{
				name: "addDuration",
				description: "Add duration to the event",
				required: true,
			}
		}
	...
	run: async (client, interaction) => {
		try{
		  const messageId = interaction.options.getString('messageId');
			const addDuration = interaction.options.getString('addDuration');
			const newWinnerCount = interaction.options.getInteger('newWinners');
			const newPrize = interaction.options.getString('newPrize');
			client.giveawaysManager
			.edit(messageId, {
				addTime: ms(addDuration),
				newWinnerCount,
				newPrize,
			})
			.then(() => {
