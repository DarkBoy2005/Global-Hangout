			    ...
			    interaction.channel.messages.fetch(`${msg2}`).then(msg3 => {msg3.reply({
			    	...
			    	embeds: [new MessageEmbed()
					  	.setTitle("Suggestion Accepted")
				   		.setColor("#00ff33")
				   		.setAuthor({
				   			name: `${taga}'s suggestion got accepted`,
				        iconURL: `${avatara}`,
				        url: `https://discord.com/channels/${interaction.guild.id}/${interaction.channel.id}/${id}`
				   		...
				   		.setDescription(`**Feedback:** ${feedback}`)
							.setFooter({
								text: `This suggestion got accepted by ${member.user.tag}`,
						  ...
						  .setColor("#00ff33")
						    ...
						    iconURL: avatara,
						 	...
						 	.addFields(
								...
								{
									name: 'Status:', value: `Accepted ${checkemoji}`, inline: true
								},
								{
					...
					try {
				   		...
				   		m.send({embeds: [new MessageEmbed()
				   			...
				   			.setDescription(`Your [suggestion](https://discord.com/channels/${interaction.guild.id}/${interaction.channel.id}/${id}) was accepted in **${interaction.guild.name}**.`)
				   			.addFields(
				   				{
										name: 'Feedback:', value: `${feedback}`, inline: false
									},
